...
# def apply_gripper_close_floor(
#     actions,
#     robot_name: str,
#     threshold: float,
#     close_value: float,
#     finger_keys: tuple[str, str] = ("panda_finger_joint1", "panda_finger_joint2"),
# ):
#     """Replace very small finger targets with a stable non-zero close target."""
...
#             value = dof_pos_target.get(key)
#             if value is not None and value <= threshold:
#                 dof_pos_target[key] = close_value


# def get_effective_physics_dt(sim_name: str, configured_dt: float | None) -> float:
#     """Infer simulator physics dt when scenario doesn't explicitly set it."""
#     if configured_dt is not None:
#         return configured_dt

#     # Keep defaults consistent with SimParamCfg docs and current MuJoCo handler implementation.
#     if sim_name == "mujoco":
#         return 1.0 / 1000.0
#     if sim_name in ("isaacgym", "isaacsim"):
#         return 1.0 / 60.0
